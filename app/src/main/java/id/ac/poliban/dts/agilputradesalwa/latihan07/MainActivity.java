package id.ac.poliban.dts.agilputradesalwa.latihan07;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId()==R.id.miMolies){
            this.getWindow().getDecorView().setBackgroundResource(R.drawable.molies);
        }
